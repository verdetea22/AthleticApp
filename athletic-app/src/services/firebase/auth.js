...
const userConverter = {
  ...
  fromFirestore: (snapshot, options) => {
    ...
    const convertToBankAccount = (bnkAccount) =>
      new BankAccount(
        bnkAccount.balance,
        bnkAccount.interest,
    ...
    const convertToRetirementBankAccount = (bnkAccount) =>
      new RetirementBankAccount(
        bnkAccount.balance,
        bnkAccount.interest,
        bnkAccount.transactionHistory.map((t) => convertToTransaction(t)),
        bnkAccount.type,
    ...
    return new User(
      ...
      data.retirementBankAccounts.map((bnk) =>
        convertToRetirementBankAccount(bnk)
      ),
      [],
      data.retirementAge,
      data.dOB.toDate()
